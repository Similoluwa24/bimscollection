        ...
        <div className="flex">
            ...
            <section className="bg-inherit w-full dark:bg-gray-900">
                ...
                <form action="#" onSubmit={createHandler}>
                    ...
                    <button type="submit" className="inline-flex items-center px-5 py-2.5 mt-4 sm:mt-6 text-sm font-medium text-center text-white bg-[brown] rounded-lg focus:ring-4  dark:focus:ring-primary-900 hover:bg-primary-800">
                        Add product
                    </button>
                </form>
            </div>
