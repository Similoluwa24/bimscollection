...
function About() {
  return (
    <div>
        ...
        <div className="text text-[#D97706] mx-20 my-2">
            <h3 className="uppercase font-bold font-[lora] text-4xl py-4">about us</h3>
            <div className="font-md txt">
                <p>Welcome to <span className='font-[tangerine] font-bold text-[#D97706]'>BimsCollection</span>, where style meets comfort in every stitch. Founded with a passion for fashion and a commitment to quality, <span className='font-[tangerine] font-bold text-[#D97706]'>BimsCollection</span> brings you a curated selection of contemporary clothing that caters to your unique sense of style.

                        At <span className='font-[tangerine] font-bold text-[#D97706]'>BimsCollection</span>, we believe that fashion should be effortless yet expressive. Our collection is carefully curated to offer a blend of timeless classics and trendy pieces, ensuring there’s something for every occasion and every mood. Whether you’re looking for the perfect outfit for a casual day out or something chic for a special event, <span className='font-[tangerine] font-bold text-[#D97706]'>BimsCollection</span> has you covered.
